...
cc.Class({
    ...
    Init:function(){
        ...
        cc.Canvas.instance.node.on(cc.Node.EventType.TOUCH_START,this.stageDowd,this);
    },
    stageDowd:function(e){
        ...
        cc.Canvas.instance.node.on(cc.Node.EventType.TOUCH_END,this.stageUp,this);
        cc.Canvas.instance.node.on(cc.Node.EventType.TOUCH_MOVE,this.stageMove,this);
    },
    stageUp:function(e){
        cc.Canvas.instance.node.off(cc.Node.EventType.TOUCH_END,this.stageUp,this);
        cc.Canvas.instance.node.off(cc.Node.EventType.TOUCH_MOVE,this.stageMove,this);
        this.moveType = 0;
        this.search();
        this.Paint();
        this.path =[];
